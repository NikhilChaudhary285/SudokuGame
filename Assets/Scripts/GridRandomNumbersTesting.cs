...
public class GridRandomNumbersTesting : MonoBehaviour
{
	[SerializeField]
	...
	//GridsButtonsReferences_GridButtons (Only Grid Buttons)
	Dictionary<int, Button[]> GridsButtonsReferences_GridButtons = new Dictionary<int, Button[]>();
	...
	#region PositionFinder Logic References
	// pickedUpButtonReference
	Button pickedUpButtonReference;
	// pickedUpButtonGrid
	GameObject pickedUpButtonGrid;
	// pickedUpButtonGridButtons
	Button[] pickedUpButtonGridButtons;

	// Holding currentPickedUpRandomValue
	int currentPickedUpRandomValue;

	// Holding pickedUpButtonGridButtonsIndex
	int pickedUpButtonGridButtonsIndex;

	// Boolean for currentPickedUpRandomValueExistence
	bool currentPickedUpRandomValueExist = false;
	#endregion

	#region swappingPositionsConditionsWithValues References
	// 
	#endregion

	#region swappingPositionsConditionsWithValues Class (References)
	// Holding SwappingPositionsConditionsWithValues against Two Suggested Positions and Values i.e.they can be applicable to swap or not
	public class swappingPositionsConditionsWithValues
	{
		public int index;
		public bool swapeable;
		public string swapeableButtonValue;
		public Button buttonIndexPosition;

		// Default Constructor : For RenInitaizing Classes with empty values if we want
		public swappingPositionsConditionsWithValues() { }
		// Constructor For Check Value is swapeable with other position or value or value's position
		public swappingPositionsConditionsWithValues(bool _swapeable)
		{
			this.swapeable = _swapeable;
		}
		// Final Constructor For Sotring Final Values
		public swappingPositionsConditionsWithValues(int _index, bool _swapeable, string _swapeableButtonValue, Button _buttonIndexPosition)
		{
			this.index = _index;
			this.swapeable = _swapeable;
			this.swapeableButtonValue = _swapeableButtonValue;
			this.buttonIndexPosition = _buttonIndexPosition;
		}

	}
	#endregion

	#region Classes : classForFirstValue || classForOhterValue

	#region classForFirstValue
	swappingPositionsConditionsWithValues classForFirstValue;
	int firstIndexValue;
	bool firstSwapeableValue;
	string firstSwapeableButtonValue;
	Button otherButtonIndexPositionValue;
	#endregion

	#region classForOhterValue
	swappingPositionsConditionsWithValues classForOhterValue;
	int otherIndexValue;
	bool otherSwapeableValue;
	string otherSwapeableButtonValue;
	Button firstButtonIndexPositionValue;
	#endregion

	#endregion

	#region Boolean for Check OhterButtonValueExistenceInAnotherLocation 
	bool OhterButtonValueExistInAnotherLocation = false;
	#endregion

	#region pickedUpButtonGridButtonsIndex List
	List<int> PickedUpButtonGridButtonsIndexList;
	#endregion
	...
	void Start()
	{
		...
		// StoringGridsButtonsReferences_GridButtons
		StoringGridsButtonsReferences_GridButtons();
	...
	#region GridsButtonsReferences_GridButtons
	void StoringGridsButtonsReferences_GridButtons()
	{
		#region 1st GridSetup (with comparisons logic)
		//For1ButtonComparisons || Index: 0
		GridsButtonsReferences_GridButtons.Add(0, new Button[] { GridButtonsInitializes[0][0], GridButtonsInitializes[0][1], GridButtonsInitializes[0][2], GridButtonsInitializes[0][3], GridButtonsInitializes[0][4], GridButtonsInitializes[0][5], GridButtonsInitializes[0][6], GridButtonsInitializes[0][7], GridButtonsInitializes[0][8] });
		//For2ButtonComparisons || Index: 1
		GridsButtonsReferences_GridButtons.Add(1, new Button[] { GridButtonsInitializes[0][0], GridButtonsInitializes[0][1], GridButtonsInitializes[0][2], GridButtonsInitializes[0][3], GridButtonsInitializes[0][4], GridButtonsInitializes[0][5], GridButtonsInitializes[0][6], GridButtonsInitializes[0][7], GridButtonsInitializes[0][8] });
		//For3ButtonComparisons || Index: 2
		GridsButtonsReferences_GridButtons.Add(2, new Button[] { GridButtonsInitializes[0][0], GridButtonsInitializes[0][1], GridButtonsInitializes[0][2], GridButtonsInitializes[0][3], GridButtonsInitializes[0][4], GridButtonsInitializes[0][5], GridButtonsInitializes[0][6], GridButtonsInitializes[0][7], GridButtonsInitializes[0][8] });
		//For4ButtonComparisons || Index: 3
		GridsButtonsReferences_GridButtons.Add(3, new Button[] { GridButtonsInitializes[0][0], GridButtonsInitializes[0][1], GridButtonsInitializes[0][2], GridButtonsInitializes[0][3], GridButtonsInitializes[0][4], GridButtonsInitializes[0][5], GridButtonsInitializes[0][6], GridButtonsInitializes[0][7], GridButtonsInitializes[0][8] });
		//For5ButtonComparisons || Index: 4
		GridsButtonsReferences_GridButtons.Add(4, new Button[] { GridButtonsInitializes[0][0], GridButtonsInitializes[0][1], GridButtonsInitializes[0][2], GridButtonsInitializes[0][3], GridButtonsInitializes[0][4], GridButtonsInitializes[0][5], GridButtonsInitializes[0][6], GridButtonsInitializes[0][7], GridButtonsInitializes[0][8] });
		//For6ButtonComparisons || Index: 5
		GridsButtonsReferences_GridButtons.Add(5, new Button[] { GridButtonsInitializes[0][0], GridButtonsInitializes[0][1], GridButtonsInitializes[0][2], GridButtonsInitializes[0][3], GridButtonsInitializes[0][4], GridButtonsInitializes[0][5], GridButtonsInitializes[0][6], GridButtonsInitializes[0][7], GridButtonsInitializes[0][8] });
		//For7ButtonComparisons || Index: 6
		GridsButtonsReferences_GridButtons.Add(6, new Button[] { GridButtonsInitializes[0][0], GridButtonsInitializes[0][1], GridButtonsInitializes[0][2], GridButtonsInitializes[0][3], GridButtonsInitializes[0][4], GridButtonsInitializes[0][5], GridButtonsInitializes[0][6], GridButtonsInitializes[0][7], GridButtonsInitializes[0][8] });
		//For8ButtonComparisons || Index: 7
		GridsButtonsReferences_GridButtons.Add(7, new Button[] { GridButtonsInitializes[0][0], GridButtonsInitializes[0][1], GridButtonsInitializes[0][2], GridButtonsInitializes[0][3], GridButtonsInitializes[0][4], GridButtonsInitializes[0][5], GridButtonsInitializes[0][6], GridButtonsInitializes[0][7], GridButtonsInitializes[0][8] });
		//For9ButtonComparisons || Index: 8
		GridsButtonsReferences_GridButtons.Add(8, new Button[] { GridButtonsInitializes[0][0], GridButtonsInitializes[0][1], GridButtonsInitializes[0][2], GridButtonsInitializes[0][3], GridButtonsInitializes[0][4], GridButtonsInitializes[0][5], GridButtonsInitializes[0][6], GridButtonsInitializes[0][7], GridButtonsInitializes[0][8] });
		#endregion

		#region 2nd GridSetup (with comparisons logic)
		//For10ButtonComparisons || Index: 9
		GridsButtonsReferences_GridButtons.Add(9, new Button[] { GridButtonsInitializes[1][0], GridButtonsInitializes[1][1], GridButtonsInitializes[1][2], GridButtonsInitializes[1][3], GridButtonsInitializes[1][4], GridButtonsInitializes[1][5], GridButtonsInitializes[1][6], GridButtonsInitializes[1][7], GridButtonsInitializes[1][8] });
		//For11ButtonComparisons || Index: 10
		GridsButtonsReferences_GridButtons.Add(10, new Button[] { GridButtonsInitializes[1][0], GridButtonsInitializes[1][1], GridButtonsInitializes[1][2], GridButtonsInitializes[1][3], GridButtonsInitializes[1][4], GridButtonsInitializes[1][5], GridButtonsInitializes[1][6], GridButtonsInitializes[1][7], GridButtonsInitializes[1][8] });
		//For12ButtonComparisons || Index: 11
		GridsButtonsReferences_GridButtons.Add(11, new Button[] { GridButtonsInitializes[1][0], GridButtonsInitializes[1][1], GridButtonsInitializes[1][2], GridButtonsInitializes[1][3], GridButtonsInitializes[1][4], GridButtonsInitializes[1][5], GridButtonsInitializes[1][6], GridButtonsInitializes[1][7], GridButtonsInitializes[1][8] });
		//For13ButtonComparisons || Index: 12
		GridsButtonsReferences_GridButtons.Add(12, new Button[] { GridButtonsInitializes[1][0], GridButtonsInitializes[1][1], GridButtonsInitializes[1][2], GridButtonsInitializes[1][3], GridButtonsInitializes[1][4], GridButtonsInitializes[1][5], GridButtonsInitializes[1][6], GridButtonsInitializes[1][7], GridButtonsInitializes[1][8] });
		//For14ButtonComparisons || Index: 13
		GridsButtonsReferences_GridButtons.Add(13, new Button[] { GridButtonsInitializes[1][0], GridButtonsInitializes[1][1], GridButtonsInitializes[1][2], GridButtonsInitializes[1][3], GridButtonsInitializes[1][4], GridButtonsInitializes[1][5], GridButtonsInitializes[1][6], GridButtonsInitializes[1][7], GridButtonsInitializes[1][8] });
		//For15ButtonComparisons || Index: 14
		GridsButtonsReferences_GridButtons.Add(14, new Button[] { GridButtonsInitializes[1][0], GridButtonsInitializes[1][1], GridButtonsInitializes[1][2], GridButtonsInitializes[1][3], GridButtonsInitializes[1][4], GridButtonsInitializes[1][5], GridButtonsInitializes[1][6], GridButtonsInitializes[1][7], GridButtonsInitializes[1][8] });
		//For16ButtonComparisons || Index: 15
		GridsButtonsReferences_GridButtons.Add(15, new Button[] { GridButtonsInitializes[1][0], GridButtonsInitializes[1][1], GridButtonsInitializes[1][2], GridButtonsInitializes[1][3], GridButtonsInitializes[1][4], GridButtonsInitializes[1][5], GridButtonsInitializes[1][6], GridButtonsInitializes[1][7], GridButtonsInitializes[1][8] });
		//For17ButtonComparisons || Index: 16
		GridsButtonsReferences_GridButtons.Add(16, new Button[] { GridButtonsInitializes[1][0], GridButtonsInitializes[1][1], GridButtonsInitializes[1][2], GridButtonsInitializes[1][3], GridButtonsInitializes[1][4], GridButtonsInitializes[1][5], GridButtonsInitializes[1][6], GridButtonsInitializes[1][7], GridButtonsInitializes[1][8] });
		//For18ButtonComparisons || Index: 17
		GridsButtonsReferences_GridButtons.Add(17, new Button[] { GridButtonsInitializes[1][0], GridButtonsInitializes[1][1], GridButtonsInitializes[1][2], GridButtonsInitializes[1][3], GridButtonsInitializes[1][4], GridButtonsInitializes[1][5], GridButtonsInitializes[1][6], GridButtonsInitializes[1][7], GridButtonsInitializes[1][8] });
		#endregion

		#region 3rd GridSetup (with comparisons logic)
		//For19ButtonComparisons || Index: 18
		GridsButtonsReferences_GridButtons.Add(18, new Button[] { GridButtonsInitializes[2][0], GridButtonsInitializes[2][1], GridButtonsInitializes[2][2], GridButtonsInitializes[2][3], GridButtonsInitializes[2][4], GridButtonsInitializes[2][5], GridButtonsInitializes[2][6], GridButtonsInitializes[2][7], GridButtonsInitializes[2][8] });
		//For20ButtonComparisons || Index: 19
		GridsButtonsReferences_GridButtons.Add(19, new Button[] { GridButtonsInitializes[2][0], GridButtonsInitializes[2][1], GridButtonsInitializes[2][2], GridButtonsInitializes[2][3], GridButtonsInitializes[2][4], GridButtonsInitializes[2][5], GridButtonsInitializes[2][6], GridButtonsInitializes[2][7], GridButtonsInitializes[2][8] });
		//For21ButtonComparisons || Index: 20
		GridsButtonsReferences_GridButtons.Add(20, new Button[] { GridButtonsInitializes[2][0], GridButtonsInitializes[2][1], GridButtonsInitializes[2][2], GridButtonsInitializes[2][3], GridButtonsInitializes[2][4], GridButtonsInitializes[2][5], GridButtonsInitializes[2][6], GridButtonsInitializes[2][7], GridButtonsInitializes[2][8] });
		//For22ButtonComparisons || Index: 21
		GridsButtonsReferences_GridButtons.Add(21, new Button[] { GridButtonsInitializes[2][0], GridButtonsInitializes[2][1], GridButtonsInitializes[2][2], GridButtonsInitializes[2][3], GridButtonsInitializes[2][4], GridButtonsInitializes[2][5], GridButtonsInitializes[2][6], GridButtonsInitializes[2][7], GridButtonsInitializes[2][8] });
		//For23ButtonComparisons || Index: 22
		GridsButtonsReferences_GridButtons.Add(22, new Button[] { GridButtonsInitializes[2][0], GridButtonsInitializes[2][1], GridButtonsInitializes[2][2], GridButtonsInitializes[2][3], GridButtonsInitializes[2][4], GridButtonsInitializes[2][5], GridButtonsInitializes[2][6], GridButtonsInitializes[2][7], GridButtonsInitializes[2][8] });
		//For24ButtonComparisons || Index: 23
		GridsButtonsReferences_GridButtons.Add(23, new Button[] { GridButtonsInitializes[2][0], GridButtonsInitializes[2][1], GridButtonsInitializes[2][2], GridButtonsInitializes[2][3], GridButtonsInitializes[2][4], GridButtonsInitializes[2][5], GridButtonsInitializes[2][6], GridButtonsInitializes[2][7], GridButtonsInitializes[2][8] });
		//For25ButtonComparisons || Index: 24
		GridsButtonsReferences_GridButtons.Add(24, new Button[] { GridButtonsInitializes[2][0], GridButtonsInitializes[2][1], GridButtonsInitializes[2][2], GridButtonsInitializes[2][3], GridButtonsInitializes[2][4], GridButtonsInitializes[2][5], GridButtonsInitializes[2][6], GridButtonsInitializes[2][7], GridButtonsInitializes[2][8] });
		//For26ButtonComparisons || Index: 25
		GridsButtonsReferences_GridButtons.Add(25, new Button[] { GridButtonsInitializes[2][0], GridButtonsInitializes[2][1], GridButtonsInitializes[2][2], GridButtonsInitializes[2][3], GridButtonsInitializes[2][4], GridButtonsInitializes[2][5], GridButtonsInitializes[2][6], GridButtonsInitializes[2][7], GridButtonsInitializes[2][8] });
		//For27ButtonComparisons || Index: 26
		GridsButtonsReferences_GridButtons.Add(26, new Button[] { GridButtonsInitializes[2][0], GridButtonsInitializes[2][1], GridButtonsInitializes[2][2], GridButtonsInitializes[2][3], GridButtonsInitializes[2][4], GridButtonsInitializes[2][5], GridButtonsInitializes[2][6], GridButtonsInitializes[2][7], GridButtonsInitializes[2][8] });
		#endregion

		#region 4th GridSetup (with comparisons logic)
		//For28ButtonComparisons || Index: 27
		GridsButtonsReferences_GridButtons.Add(27, new Button[] { GridButtonsInitializes[3][0], GridButtonsInitializes[3][1], GridButtonsInitializes[3][2], GridButtonsInitializes[3][3], GridButtonsInitializes[3][4], GridButtonsInitializes[3][5], GridButtonsInitializes[3][6], GridButtonsInitializes[3][7], GridButtonsInitializes[3][8] });
		//For29ButtonComparisons || Index: 28
		GridsButtonsReferences_GridButtons.Add(28, new Button[] { GridButtonsInitializes[3][0], GridButtonsInitializes[3][1], GridButtonsInitializes[3][2], GridButtonsInitializes[3][3], GridButtonsInitializes[3][4], GridButtonsInitializes[3][5], GridButtonsInitializes[3][6], GridButtonsInitializes[3][7], GridButtonsInitializes[3][8] });
		//For30ButtonComparisons || Index: 29
		GridsButtonsReferences_GridButtons.Add(29, new Button[] { GridButtonsInitializes[3][0], GridButtonsInitializes[3][1], GridButtonsInitializes[3][2], GridButtonsInitializes[3][3], GridButtonsInitializes[3][4], GridButtonsInitializes[3][5], GridButtonsInitializes[3][6], GridButtonsInitializes[3][7], GridButtonsInitializes[3][8] });
		//For31ButtonComparisons || Index: 30
		GridsButtonsReferences_GridButtons.Add(30, new Button[] { GridButtonsInitializes[3][0], GridButtonsInitializes[3][1], GridButtonsInitializes[3][2], GridButtonsInitializes[3][3], GridButtonsInitializes[3][4], GridButtonsInitializes[3][5], GridButtonsInitializes[3][6], GridButtonsInitializes[3][7], GridButtonsInitializes[3][8] });
		//For32ButtonComparisons || Index: 31
		GridsButtonsReferences_GridButtons.Add(31, new Button[] { GridButtonsInitializes[3][0], GridButtonsInitializes[3][1], GridButtonsInitializes[3][2], GridButtonsInitializes[3][3], GridButtonsInitializes[3][4], GridButtonsInitializes[3][5], GridButtonsInitializes[3][6], GridButtonsInitializes[3][7], GridButtonsInitializes[3][8] });
		//For33ButtonComparisons || Index: 32
		GridsButtonsReferences_GridButtons.Add(32, new Button[] { GridButtonsInitializes[3][0], GridButtonsInitializes[3][1], GridButtonsInitializes[3][2], GridButtonsInitializes[3][3], GridButtonsInitializes[3][4], GridButtonsInitializes[3][5], GridButtonsInitializes[3][6], GridButtonsInitializes[3][7], GridButtonsInitializes[3][8] });
		//For34ButtonComparisons || Index: 33
		GridsButtonsReferences_GridButtons.Add(33, new Button[] { GridButtonsInitializes[3][0], GridButtonsInitializes[3][1], GridButtonsInitializes[3][2], GridButtonsInitializes[3][3], GridButtonsInitializes[3][4], GridButtonsInitializes[3][5], GridButtonsInitializes[3][6], GridButtonsInitializes[3][7], GridButtonsInitializes[3][8] });
		//For35ButtonComparisons || Index: 34
		GridsButtonsReferences_GridButtons.Add(34, new Button[] { GridButtonsInitializes[3][0], GridButtonsInitializes[3][1], GridButtonsInitializes[3][2], GridButtonsInitializes[3][3], GridButtonsInitializes[3][4], GridButtonsInitializes[3][5], GridButtonsInitializes[3][6], GridButtonsInitializes[3][7], GridButtonsInitializes[3][8] });
		//For36ButtonComparisons || Index: 35
		GridsButtonsReferences_GridButtons.Add(35, new Button[] { GridButtonsInitializes[3][0], GridButtonsInitializes[3][1], GridButtonsInitializes[3][2], GridButtonsInitializes[3][3], GridButtonsInitializes[3][4], GridButtonsInitializes[3][5], GridButtonsInitializes[3][6], GridButtonsInitializes[3][7], GridButtonsInitializes[3][8] });
		#endregion

		#region 5th GridSetup (with comparisons logic)
		//For37ButtonComparisons || Index: 36
		GridsButtonsReferences_GridButtons.Add(36, new Button[] { GridButtonsInitializes[4][0], GridButtonsInitializes[4][1], GridButtonsInitializes[4][2], GridButtonsInitializes[4][3], GridButtonsInitializes[4][4], GridButtonsInitializes[4][5], GridButtonsInitializes[4][6], GridButtonsInitializes[4][7], GridButtonsInitializes[4][8] });
		//For38ButtonComparisons || Index: 37
		GridsButtonsReferences_GridButtons.Add(37, new Button[] { GridButtonsInitializes[4][0], GridButtonsInitializes[4][1], GridButtonsInitializes[4][2], GridButtonsInitializes[4][3], GridButtonsInitializes[4][4], GridButtonsInitializes[4][5], GridButtonsInitializes[4][6], GridButtonsInitializes[4][7], GridButtonsInitializes[4][8] });
		//For39ButtonComparisons || Index: 38
		GridsButtonsReferences_GridButtons.Add(38, new Button[] { GridButtonsInitializes[4][0], GridButtonsInitializes[4][1], GridButtonsInitializes[4][2], GridButtonsInitializes[4][3], GridButtonsInitializes[4][4], GridButtonsInitializes[4][5], GridButtonsInitializes[4][6], GridButtonsInitializes[4][7], GridButtonsInitializes[4][8] });
		//For40ButtonComparisons || Index: 39
		GridsButtonsReferences_GridButtons.Add(39, new Button[] { GridButtonsInitializes[4][0], GridButtonsInitializes[4][1], GridButtonsInitializes[4][2], GridButtonsInitializes[4][3], GridButtonsInitializes[4][4], GridButtonsInitializes[4][5], GridButtonsInitializes[4][6], GridButtonsInitializes[4][7], GridButtonsInitializes[4][8] });
		//For41ButtonComparisons || Index: 40
		GridsButtonsReferences_GridButtons.Add(40, new Button[] { GridButtonsInitializes[4][0], GridButtonsInitializes[4][1], GridButtonsInitializes[4][2], GridButtonsInitializes[4][3], GridButtonsInitializes[4][4], GridButtonsInitializes[4][5], GridButtonsInitializes[4][6], GridButtonsInitializes[4][7], GridButtonsInitializes[4][8] });
		//For42ButtonComparisons || Index: 41
		GridsButtonsReferences_GridButtons.Add(41, new Button[] { GridButtonsInitializes[4][0], GridButtonsInitializes[4][1], GridButtonsInitializes[4][2], GridButtonsInitializes[4][3], GridButtonsInitializes[4][4], GridButtonsInitializes[4][5], GridButtonsInitializes[4][6], GridButtonsInitializes[4][7], GridButtonsInitializes[4][8] });
		//For43ButtonComparisons || Index: 42
		GridsButtonsReferences_GridButtons.Add(42, new Button[] { GridButtonsInitializes[4][0], GridButtonsInitializes[4][1], GridButtonsInitializes[4][2], GridButtonsInitializes[4][3], GridButtonsInitializes[4][4], GridButtonsInitializes[4][5], GridButtonsInitializes[4][6], GridButtonsInitializes[4][7], GridButtonsInitializes[4][8] });
		//For44ButtonComparisons || Index: 43
		GridsButtonsReferences_GridButtons.Add(43, new Button[] { GridButtonsInitializes[4][0], GridButtonsInitializes[4][1], GridButtonsInitializes[4][2], GridButtonsInitializes[4][3], GridButtonsInitializes[4][4], GridButtonsInitializes[4][5], GridButtonsInitializes[4][6], GridButtonsInitializes[4][7], GridButtonsInitializes[4][8] });
		//For45ButtonComparisons || Index: 44
		GridsButtonsReferences_GridButtons.Add(44, new Button[] { GridButtonsInitializes[4][0], GridButtonsInitializes[4][1], GridButtonsInitializes[4][2], GridButtonsInitializes[4][3], GridButtonsInitializes[4][4], GridButtonsInitializes[4][5], GridButtonsInitializes[4][6], GridButtonsInitializes[4][7], GridButtonsInitializes[4][8] });
		#endregion

		#region 6th GridSetup (with comparisons logic)
		//For46ButtonComparisons || Index: 45
		GridsButtonsReferences_GridButtons.Add(45, new Button[] { GridButtonsInitializes[5][0], GridButtonsInitializes[5][1], GridButtonsInitializes[5][2], GridButtonsInitializes[5][3], GridButtonsInitializes[5][4], GridButtonsInitializes[5][5], GridButtonsInitializes[5][6], GridButtonsInitializes[5][7], GridButtonsInitializes[5][8] });
		//For47ButtonComparisons || Index: 46
		GridsButtonsReferences_GridButtons.Add(46, new Button[] { GridButtonsInitializes[5][0], GridButtonsInitializes[5][1], GridButtonsInitializes[5][2], GridButtonsInitializes[5][3], GridButtonsInitializes[5][4], GridButtonsInitializes[5][5], GridButtonsInitializes[5][6], GridButtonsInitializes[5][7], GridButtonsInitializes[5][8] });
		//For48ButtonComparisons || Index: 47
		GridsButtonsReferences_GridButtons.Add(47, new Button[] { GridButtonsInitializes[5][0], GridButtonsInitializes[5][1], GridButtonsInitializes[5][2], GridButtonsInitializes[5][3], GridButtonsInitializes[5][4], GridButtonsInitializes[5][5], GridButtonsInitializes[5][6], GridButtonsInitializes[5][7], GridButtonsInitializes[5][8] });
		//For49ButtonComparisons || Index: 48
		GridsButtonsReferences_GridButtons.Add(48, new Button[] { GridButtonsInitializes[5][0], GridButtonsInitializes[5][1], GridButtonsInitializes[5][2], GridButtonsInitializes[5][3], GridButtonsInitializes[5][4], GridButtonsInitializes[5][5], GridButtonsInitializes[5][6], GridButtonsInitializes[5][7], GridButtonsInitializes[5][8] });
		//For50ButtonComparisons || Index: 49
		GridsButtonsReferences_GridButtons.Add(49, new Button[] { GridButtonsInitializes[5][0], GridButtonsInitializes[5][1], GridButtonsInitializes[5][2], GridButtonsInitializes[5][3], GridButtonsInitializes[5][4], GridButtonsInitializes[5][5], GridButtonsInitializes[5][6], GridButtonsInitializes[5][7], GridButtonsInitializes[5][8] });
		//For51ButtonComparisons || Index: 50
		GridsButtonsReferences_GridButtons.Add(50, new Button[] { GridButtonsInitializes[5][0], GridButtonsInitializes[5][1], GridButtonsInitializes[5][2], GridButtonsInitializes[5][3], GridButtonsInitializes[5][4], GridButtonsInitializes[5][5], GridButtonsInitializes[5][6], GridButtonsInitializes[5][7], GridButtonsInitializes[5][8] });
		//For52ButtonComparisons || Index: 51
		GridsButtonsReferences_GridButtons.Add(51, new Button[] { GridButtonsInitializes[5][0], GridButtonsInitializes[5][1], GridButtonsInitializes[5][2], GridButtonsInitializes[5][3], GridButtonsInitializes[5][4], GridButtonsInitializes[5][5], GridButtonsInitializes[5][6], GridButtonsInitializes[5][7], GridButtonsInitializes[5][8] });
		//For53ButtonComparisons || Index: 52
		GridsButtonsReferences_GridButtons.Add(52, new Button[] { GridButtonsInitializes[5][0], GridButtonsInitializes[5][1], GridButtonsInitializes[5][2], GridButtonsInitializes[5][3], GridButtonsInitializes[5][4], GridButtonsInitializes[5][5], GridButtonsInitializes[5][6], GridButtonsInitializes[5][7], GridButtonsInitializes[5][8] });
		//For54ButtonComparisons || Index: 53
		GridsButtonsReferences_GridButtons.Add(53, new Button[] { GridButtonsInitializes[5][0], GridButtonsInitializes[5][1], GridButtonsInitializes[5][2], GridButtonsInitializes[5][3], GridButtonsInitializes[5][4], GridButtonsInitializes[5][5], GridButtonsInitializes[5][6], GridButtonsInitializes[5][7], GridButtonsInitializes[5][8] });
		#endregion

		#region 7th GridSetup (with comparisons logic)
		//For55ButtonComparisons || Index: 54
		GridsButtonsReferences_GridButtons.Add(54, new Button[] { GridButtonsInitializes[6][0], GridButtonsInitializes[6][1], GridButtonsInitializes[6][2], GridButtonsInitializes[6][3], GridButtonsInitializes[6][4], GridButtonsInitializes[6][5], GridButtonsInitializes[6][6], GridButtonsInitializes[6][7], GridButtonsInitializes[6][8] });
		//For56ButtonComparisons || Index: 55
		GridsButtonsReferences_GridButtons.Add(55, new Button[] { GridButtonsInitializes[6][0], GridButtonsInitializes[6][1], GridButtonsInitializes[6][2], GridButtonsInitializes[6][3], GridButtonsInitializes[6][4], GridButtonsInitializes[6][5], GridButtonsInitializes[6][6], GridButtonsInitializes[6][7], GridButtonsInitializes[6][8] });
		//For57ButtonComparisons || Index: 56
		GridsButtonsReferences_GridButtons.Add(56, new Button[] { GridButtonsInitializes[6][0], GridButtonsInitializes[6][1], GridButtonsInitializes[6][2], GridButtonsInitializes[6][3], GridButtonsInitializes[6][4], GridButtonsInitializes[6][5], GridButtonsInitializes[6][6], GridButtonsInitializes[6][7], GridButtonsInitializes[6][8] });
		//For58ButtonComparisons || Index: 57
		GridsButtonsReferences_GridButtons.Add(57, new Button[] { GridButtonsInitializes[6][0], GridButtonsInitializes[6][1], GridButtonsInitializes[6][2], GridButtonsInitializes[6][3], GridButtonsInitializes[6][4], GridButtonsInitializes[6][5], GridButtonsInitializes[6][6], GridButtonsInitializes[6][7], GridButtonsInitializes[6][8] });
		//For59ButtonComparisons || Index: 58
		GridsButtonsReferences_GridButtons.Add(58, new Button[] { GridButtonsInitializes[6][0], GridButtonsInitializes[6][1], GridButtonsInitializes[6][2], GridButtonsInitializes[6][3], GridButtonsInitializes[6][4], GridButtonsInitializes[6][5], GridButtonsInitializes[6][6], GridButtonsInitializes[6][7], GridButtonsInitializes[6][8] });
		//For60ButtonComparisons || Index: 59
		GridsButtonsReferences_GridButtons.Add(59, new Button[] { GridButtonsInitializes[6][0], GridButtonsInitializes[6][1], GridButtonsInitializes[6][2], GridButtonsInitializes[6][3], GridButtonsInitializes[6][4], GridButtonsInitializes[6][5], GridButtonsInitializes[6][6], GridButtonsInitializes[6][7], GridButtonsInitializes[6][8] });
		//For61ButtonComparisons || Index: 60
		GridsButtonsReferences_GridButtons.Add(60, new Button[] { GridButtonsInitializes[6][0], GridButtonsInitializes[6][1], GridButtonsInitializes[6][2], GridButtonsInitializes[6][3], GridButtonsInitializes[6][4], GridButtonsInitializes[6][5], GridButtonsInitializes[6][6], GridButtonsInitializes[6][7], GridButtonsInitializes[6][8] });
		//For62ButtonComparisons || Index: 61
		GridsButtonsReferences_GridButtons.Add(61, new Button[] { GridButtonsInitializes[6][0], GridButtonsInitializes[6][1], GridButtonsInitializes[6][2], GridButtonsInitializes[6][3], GridButtonsInitializes[6][4], GridButtonsInitializes[6][5], GridButtonsInitializes[6][6], GridButtonsInitializes[6][7], GridButtonsInitializes[6][8] });
		//For63ButtonComparisons || Index: 62
		GridsButtonsReferences_GridButtons.Add(62, new Button[] { GridButtonsInitializes[6][0], GridButtonsInitializes[6][1], GridButtonsInitializes[6][2], GridButtonsInitializes[6][3], GridButtonsInitializes[6][4], GridButtonsInitializes[6][5], GridButtonsInitializes[6][6], GridButtonsInitializes[6][7], GridButtonsInitializes[6][8] });
		#endregion

		#region 8th GridSetup (with comparisons logic)
		//For64ButtonComparisons || Index: 63
		GridsButtonsReferences_GridButtons.Add(63, new Button[] { GridButtonsInitializes[7][0], GridButtonsInitializes[7][1], GridButtonsInitializes[7][2], GridButtonsInitializes[7][3], GridButtonsInitializes[7][4], GridButtonsInitializes[7][5], GridButtonsInitializes[7][6], GridButtonsInitializes[7][7], GridButtonsInitializes[7][8] });
		//For65ButtonComparisons || Index: 64
		GridsButtonsReferences_GridButtons.Add(64, new Button[] { GridButtonsInitializes[7][0], GridButtonsInitializes[7][1], GridButtonsInitializes[7][2], GridButtonsInitializes[7][3], GridButtonsInitializes[7][4], GridButtonsInitializes[7][5], GridButtonsInitializes[7][6], GridButtonsInitializes[7][7], GridButtonsInitializes[7][8] });
		//For66ButtonComparisons || Index: 65
		GridsButtonsReferences_GridButtons.Add(65, new Button[] { GridButtonsInitializes[7][0], GridButtonsInitializes[7][1], GridButtonsInitializes[7][2], GridButtonsInitializes[7][3], GridButtonsInitializes[7][4], GridButtonsInitializes[7][5], GridButtonsInitializes[7][6], GridButtonsInitializes[7][7], GridButtonsInitializes[7][8] });
		//For67ButtonComparisons || Index: 66
		GridsButtonsReferences_GridButtons.Add(66, new Button[] { GridButtonsInitializes[7][0], GridButtonsInitializes[7][1], GridButtonsInitializes[7][2], GridButtonsInitializes[7][3], GridButtonsInitializes[7][4], GridButtonsInitializes[7][5], GridButtonsInitializes[7][6], GridButtonsInitializes[7][7], GridButtonsInitializes[7][8] });
		//For68ButtonComparisons || Index: 67
		GridsButtonsReferences_GridButtons.Add(67, new Button[] { GridButtonsInitializes[7][0], GridButtonsInitializes[7][1], GridButtonsInitializes[7][2], GridButtonsInitializes[7][3], GridButtonsInitializes[7][4], GridButtonsInitializes[7][5], GridButtonsInitializes[7][6], GridButtonsInitializes[7][7], GridButtonsInitializes[7][8] });
		//For69ButtonComparisons || Index: 68
		GridsButtonsReferences_GridButtons.Add(68, new Button[] { GridButtonsInitializes[7][0], GridButtonsInitializes[7][1], GridButtonsInitializes[7][2], GridButtonsInitializes[7][3], GridButtonsInitializes[7][4], GridButtonsInitializes[7][5], GridButtonsInitializes[7][6], GridButtonsInitializes[7][7], GridButtonsInitializes[7][8] });
		//For70ButtonComparisons || Index: 69
		GridsButtonsReferences_GridButtons.Add(69, new Button[] { GridButtonsInitializes[7][0], GridButtonsInitializes[7][1], GridButtonsInitializes[7][2], GridButtonsInitializes[7][3], GridButtonsInitializes[7][4], GridButtonsInitializes[7][5], GridButtonsInitializes[7][6], GridButtonsInitializes[7][7], GridButtonsInitializes[7][8] });
		//For71ButtonComparisons || Index: 70
		GridsButtonsReferences_GridButtons.Add(70, new Button[] { GridButtonsInitializes[7][0], GridButtonsInitializes[7][1], GridButtonsInitializes[7][2], GridButtonsInitializes[7][3], GridButtonsInitializes[7][4], GridButtonsInitializes[7][5], GridButtonsInitializes[7][6], GridButtonsInitializes[7][7], GridButtonsInitializes[7][8] });
		//For72ButtonComparisons || Index: 71
		GridsButtonsReferences_GridButtons.Add(71, new Button[] { GridButtonsInitializes[7][0], GridButtonsInitializes[7][1], GridButtonsInitializes[7][2], GridButtonsInitializes[7][3], GridButtonsInitializes[7][4], GridButtonsInitializes[7][5], GridButtonsInitializes[7][6], GridButtonsInitializes[7][7], GridButtonsInitializes[7][8] });
		#endregion

		#region 9th GridSetup (with comparisons logic)
		//For73ButtonComparisons || Index: 72
		GridsButtonsReferences_GridButtons.Add(72, new Button[] { GridButtonsInitializes[8][0], GridButtonsInitializes[8][1], GridButtonsInitializes[8][2], GridButtonsInitializes[8][3], GridButtonsInitializes[8][4], GridButtonsInitializes[8][5], GridButtonsInitializes[8][6], GridButtonsInitializes[8][7], GridButtonsInitializes[8][8] });
		//For74ButtonComparisons || Index: 73
		GridsButtonsReferences_GridButtons.Add(73, new Button[] { GridButtonsInitializes[8][0], GridButtonsInitializes[8][1], GridButtonsInitializes[8][2], GridButtonsInitializes[8][3], GridButtonsInitializes[8][4], GridButtonsInitializes[8][5], GridButtonsInitializes[8][6], GridButtonsInitializes[8][7], GridButtonsInitializes[8][8] });
		//For75ButtonComparisons || Index: 74
		GridsButtonsReferences_GridButtons.Add(74, new Button[] { GridButtonsInitializes[8][0], GridButtonsInitializes[8][1], GridButtonsInitializes[8][2], GridButtonsInitializes[8][3], GridButtonsInitializes[8][4], GridButtonsInitializes[8][5], GridButtonsInitializes[8][6], GridButtonsInitializes[8][7], GridButtonsInitializes[8][8] });
		//For76ButtonComparisons || Index: 75
		GridsButtonsReferences_GridButtons.Add(75, new Button[] { GridButtonsInitializes[8][0], GridButtonsInitializes[8][1], GridButtonsInitializes[8][2], GridButtonsInitializes[8][3], GridButtonsInitializes[8][4], GridButtonsInitializes[8][5], GridButtonsInitializes[8][6], GridButtonsInitializes[8][7], GridButtonsInitializes[8][8] });
		//For77ButtonComparisons || Index: 76
		GridsButtonsReferences_GridButtons.Add(76, new Button[] { GridButtonsInitializes[8][0], GridButtonsInitializes[8][1], GridButtonsInitializes[8][2], GridButtonsInitializes[8][3], GridButtonsInitializes[8][4], GridButtonsInitializes[8][5], GridButtonsInitializes[8][6], GridButtonsInitializes[8][7], GridButtonsInitializes[8][8] });
		//For78ButtonComparisons || Index: 77
		GridsButtonsReferences_GridButtons.Add(77, new Button[] { GridButtonsInitializes[8][0], GridButtonsInitializes[8][1], GridButtonsInitializes[8][2], GridButtonsInitializes[8][3], GridButtonsInitializes[8][4], GridButtonsInitializes[8][5], GridButtonsInitializes[8][6], GridButtonsInitializes[8][7], GridButtonsInitializes[8][8] });
		//For79ButtonComparisons || Index: 78
		GridsButtonsReferences_GridButtons.Add(78, new Button[] { GridButtonsInitializes[8][0], GridButtonsInitializes[8][1], GridButtonsInitializes[8][2], GridButtonsInitializes[8][3], GridButtonsInitializes[8][4], GridButtonsInitializes[8][5], GridButtonsInitializes[8][6], GridButtonsInitializes[8][7], GridButtonsInitializes[8][8] });
		//For80ButtonComparisons || Index: 79
		GridsButtonsReferences_GridButtons.Add(79, new Button[] { GridButtonsInitializes[8][0], GridButtonsInitializes[8][1], GridButtonsInitializes[8][2], GridButtonsInitializes[8][3], GridButtonsInitializes[8][4], GridButtonsInitializes[8][5], GridButtonsInitializes[8][6], GridButtonsInitializes[8][7], GridButtonsInitializes[8][8] });
		//For81ButtonComparisons || Index: 80
		GridsButtonsReferences_GridButtons.Add(80, new Button[] { GridButtonsInitializes[8][0], GridButtonsInitializes[8][1], GridButtonsInitializes[8][2], GridButtonsInitializes[8][3], GridButtonsInitializes[8][4], GridButtonsInitializes[8][5], GridButtonsInitializes[8][6], GridButtonsInitializes[8][7], GridButtonsInitializes[8][8] });
		#endregion
	}
	#endregion

	#region GridsButtonsReferences
	void StoringGridsButtonsReferences()
	{
		#region 1st GridSetup (with comparisons logic)
		//For1ButtonComparisons || Index: 0
	...
	#region SwappingPositionsConditionsWithValuesBothClasses
	void ReinitializeSwappingPositionsConditionsWithValuesBothClasses()
	{
		classForFirstValue = new swappingPositionsConditionsWithValues();
		classForOhterValue = new swappingPositionsConditionsWithValues();

	}
	#endregion

	#region GridValuesGenerator
	void GridValuesGenerator()
	{
		...
		// RandomValueExistInAnotherLocation Boolean
		bool RandomValueExistInAnotherLocation = false;
		...
		while (currentFilledGrids < Grids.Length)
		{
			...
			while (currentFilledGridElementsValues < currentSelectedGridButtons.Length)
			{
				...
				#region For Loop for RemoveExistingGridValuesfromRandomIndexList : Loop for remove already existing values in grid from randomIndexList
				...
				#region Choosing RandomValue from randomIndexList
				randomIndex = Random.Range(0, randomIndexList.Count);
				// Storing randomIndexValue to put at a specific Position or in specific Button
				randomIndexValue = randomIndexList[randomIndex];
				#endregion

				#region For Loop for GridsButtonsReferences Comparisons : Comparisons with values Vertically and Horizontally Logic
				for (int i = 0; i < GridsButtonsReferences[gridFilledMainCells].Length; i++)
				{
					RandomValueExistInAnotherLocation = false;
					...
					if (randomIndexValue.ToString() == currentGridButtonStringValue)
					{
						RandomValueExistInAnotherLocation = true;
						break;
					}
				...
				if (!RandomValueExistInAnotherLocation)
				{
					// ThenPutThatrandomIndexValue in current position instantly

					// Finally putting specific value (randomIndexValue) at SpecificPosition or Place
				...
				{
					#region Logic To Swap Positions With Values
					// pickedUpButton
					pickedUpButton = currentSelectedGridButtons[currentFilledGridElementsValues];
					// pickedUpButtonReference
					pickedUpButtonReference = pickedUpButton;
					// pickedUpButtonGrid
					pickedUpButtonGrid = pickedUpButtonReference.transform.parent.parent.gameObject;
					// pickedUpButtonGridButtons
					pickedUpButtonGridButtons = pickedUpButtonGrid.GetComponentsInChildren<Button>();

					// currentPickedUpRandomValue
					currentPickedUpRandomValue = randomIndexValue;

					#region ReInitializingPickedUpButtonGridButtonsIndexList
					PickedUpButtonGridButtonsIndexList = new List<int>() { 0, 1, 2, 3, 4, 5, 6, 7, 8 };
					#endregion

					// pickedUpButtonGridButtonsIndex
					pickedUpButtonGridButtonsIndex = -1;

					// ReinitializeSwappingPositionsConditionsWithValuesBothClasses
					ReinitializeSwappingPositionsConditionsWithValuesBothClasses();

					// PositionFinder Main Method
					PositionFinder(currentPickedUpRandomValue);

					#region Finally Swapping Postitions of Two Values : Finally Giving Resultant Positions with Values To store it
					if (classForFirstValue.swapeable && classForOhterValue.swapeable)
					{
						// classForFirstValue References To Store values for putting first button's value at specific correct position
						firstSwapeableButtonValue = classForFirstValue.swapeableButtonValue;
						otherButtonIndexPositionValue = classForFirstValue.buttonIndexPosition;

						// classForOhterValue References To Store values for putting other button's value at specific replaceable element's position
						otherSwapeableButtonValue = classForOhterValue.swapeableButtonValue;
						firstButtonIndexPositionValue = classForOhterValue.buttonIndexPosition;

						#region Finally Swapping Postitions of Two Values
						// Putting firstSwapeableButtonValue in otherButtonIndexPositionValue
						otherButtonIndexPositionValue.GetComponentInChildren<TMP_Text>().text = firstSwapeableButtonValue;
						// Putting otherSwapeableButtonValue in firstButtonIndexPositionValue
						firstButtonIndexPositionValue.GetComponentInChildren<TMP_Text>().text = otherSwapeableButtonValue;
						#endregion
					...
					#region Notes
					//1) Go to each position of grid and comparison with all CurrentGridsButtonsReferences's selected position and check randomIndexValue is present or not in CurrentGridsButtonsReferences And if not, then we Find Correct Position for randomIndexValue by SpecificGridsButtonsReferences Comparisons Logic
					//2) if we find that position then get it and at that position
					//3) if any value is existing then simply, first grasp this value and also check if that value can be applicable to insert at replaceable's element position or not by SpecificGridsButtonsReferences Comparisons Logic
					//4) And if that value is applicable to replace, then swap position of randomIndexValue with specific calculated position
					//5) else continue 1) concept until we find that correct position for randomIndexValue
					//5) else continue 1) concept until we find that correct position for randomIndexValue
					#endregion
				...
				#region currentUniqueFilledGridElementsValues or increment some values to iterate over all buttons of each grid				
	...
	string list;
	int pickedUpBtnGridBtnsIndex = 0;
	#region PositionFinder MainMethod1
	void PositionFinder(int currentPickedUpRandomValue)
	{
		// currentGridButtonComparisonsButtonsStringValue
		string currentGridButtonComparisonsButtonsStringValue;

		// pickedUpButtonGridButtonsIndex Increment To select next button or button position for all specific comparisons and with this : -> To findout correct position for randomIndexValue
		// pickedUpButtonGridButtonsIndex++; //ReInitialize
		
		pickedUpBtnGridBtnsIndex = pickedUpButtonGridButtonsIndex + 1;

		/*#region another PickedUpButtonGridButtonsIndexList[] logic
		pickedUpButtonGridButtonsIndex = PickedUpButtonGridButtonsIndexList[pickedUpBtnGridBtnsIndex];
		#endregion

		#region another PickedUpButtonGridButtonsIndexList[] logic with(***picking number by indexing checking ***)
		list = "";
		for (int i = 0; i < PickedUpButtonGridButtonsIndexList.Count; i++)
		{
			list += PickedUpButtonGridButtonsIndexList[i] + ", ";
		}
		Debug.Log($"PickedUpButtonGridButtonsIndexList: {list} 1pickedUpButtonGridButtonsIndex: {pickedUpButtonGridButtonsIndex} 1pickedUpButtonGridButtonsIndex: {pickedUpBtnGridBtnsIndex}");
		#endregion

		#region another PickedUpButtonGridButtonsIndexList[] logic with (*** picking number randomly ***)
		pickedUpBtnGridBtnsIndex = Random.Range(0, PickedUpButtonGridButtonsIndexList.Count);
		//Debug.Log($"pickedUpBtnGridBtnsIndex: {pickedUpBtnGridBtnsIndex} 1pickedUpButtonGridButtonsIndex: {pickedUpButtonGridButtonsIndex} 1pickedUpButtonGridButtonsIndex: {pickedUpBtnGridBtnsIndex}");
		#endregion*/
		...
		//Debug.Log($"pickedUpButtonGridButtonsIndex: {pickedUpButtonGridButtonsIndex} GridsButtonsReferencesCurrentButtonIndex: {GridsButtonsReferencesCurrentButtonIndex}");

		// Giving GridsButtonsReferencesCurrentButton : Giving reference or To suggesting GridsButtonsReferencesCurrentButton Position
		Button GridsButtonsReferencesCurrentButton = pickedUpButtonGridButtons[pickedUpButtonGridButtonsIndex];
		...
		{
			// Checking currentPickedUpRandomValueExist or not in CurrentGridsButtonsReferences
			currentPickedUpRandomValueExist = false;
			// currentGridButtonComparisonsButtonsStringValue
			currentGridButtonComparisonsButtonsStringValue = GridsButtonsReferences[GridsButtonsReferencesCurrentButtonIndex][GridsButtonsReferencesIndex].GetComponentInChildren<TMP_Text>().text;
			if (currentPickedUpRandomValue.ToString() == currentGridButtonComparisonsButtonsStringValue)
			{
		...
		#region Another Internal Logic also for VandHGridsButtonsReferences's Comparisons
		/*if (currentPickedUpRandomValueExist)
		{
			for (int VandHGridsButtonsReferencesIndex = 0; VandHGridsButtonsReferencesIndex < GridsButtonsReferences[GridsButtonsReferencesCurrentButtonIndex].Length; VandHGridsButtonsReferencesIndex++)
			{
				// Giving GridsButtonsReferencesCurrentButtonIndex : To suggesting AllGridsButtonsReferences for Comparisons with others
				int VandHGridsButtonsReferencesCurrentButtonIndex = int.Parse(GridsButtonsReferences[GridsButtonsReferencesCurrentButtonIndex][VandHGridsButtonsReferencesIndex].gameObject.name.Substring(0, 2));

				// Giving GridsButtonsReferencesCurrentButton : Giving reference or To suggesting GridsButtonsReferencesCurrentButton Position
				GridsButtonsReferencesCurrentButton = GridsButtonsReferences[GridsButtonsReferencesCurrentButtonIndex][VandHGridsButtonsReferencesIndex];

				#region for loop for vertically and horiontally GridsButtonsReferences Comparisons
				for (int GridsButtonsReferencesInd = 0; GridsButtonsReferencesInd < GridsButtonsReferences[VandHGridsButtonsReferencesCurrentButtonIndex].Length; GridsButtonsReferencesInd++)
				{
					// Checking currentPickedUpRandomValueExist or not in CurrentGridsButtonsReferences
					currentPickedUpRandomValueExist = false;
					// currentGridButtonComparisonsButtonsStringValue
					currentGridButtonComparisonsButtonsStringValue = GridsButtonsReferences[VandHGridsButtonsReferencesCurrentButtonIndex][GridsButtonsReferencesInd].GetComponentInChildren<TMP_Text>().text;
					if (currentPickedUpRandomValue.ToString() == currentGridButtonComparisonsButtonsStringValue)
					{
						currentPickedUpRandomValueExist = true;
						break;
		...
		{
			// classForFirstValue
			classForFirstValue = new swappingPositionsConditionsWithValues(0, true, currentPickedUpRandomValue.ToString(), GridsButtonsReferencesCurrentButton); ;
			firstSwapeableValue = classForFirstValue.swapeable;
			otherButtonIndexPositionValue = classForFirstValue.buttonIndexPosition;
			if (firstSwapeableValue)
			{
				ComparisonMachineForOtherButtonValue();
		...
		{
			PositionFinder(currentPickedUpRandomValue);
			//classForFirstValue = new swappingPositionsConditionsWithValues(false);
	...
	#region ComparisonMachineForOtherButtonValue MainMethod2
	void ComparisonMachineForOtherButtonValue()
	{
		// FirstButtonIndexPositionValue
		firstButtonIndexPositionValue = pickedUpButtonReference;

		// Storing FirstButtonIndex: To suggesting AllGridsButtonsReferences for Comparisons with others values Vertically and Horizontally Logic
		int FirstButtonIndex = int.Parse(firstButtonIndexPositionValue.gameObject.name.Substring(0, 2));

		// OhterButtonValue
		string OhterButtonValue = otherButtonIndexPositionValue.GetComponentInChildren<TMP_Text>().text;

		#region For Loop for GridsButtonsReferences Comparisons : Comparisons with values Vertically and Horizontally Logic
		for (int i = 0; i < GridsButtonsReferences[FirstButtonIndex].Length; i++)
		{
			OhterButtonValueExistInAnotherLocation = false;

			// Comparisons with values Vertically and Horizontally Logic
			string currentGridButtonStringValue = GridsButtonsReferences[FirstButtonIndex][i].GetComponentInChildren<TMP_Text>().text;
			if (OhterButtonValue == currentGridButtonStringValue)
			{
				OhterButtonValueExistInAnotherLocation = true;
				break;
			}
		...
		if (!OhterButtonValueExistInAnotherLocation)
		{
			classForOhterValue = new swappingPositionsConditionsWithValues(1, true, OhterButtonValue, firstButtonIndexPositionValue);
			otherSwapeableValue = classForOhterValue.swapeable;
			firstButtonIndexPositionValue = classForOhterValue.buttonIndexPosition;
		...
		{
			#region check logic
			/*int pickedUpButtonGridButtonsRemoveableIndexElementFromPickedUpButtonGridButtonsIndexList = 0;
			for (int pickupUpButtonGridButtonsIndex = 0; pickupUpButtonGridButtonsIndex < pickedUpButtonGridButtons.Length; pickupUpButtonGridButtonsIndex++)
			{
				if (otherButtonIndexPositionValue == pickedUpButtonGridButtons[pickupUpButtonGridButtonsIndex])
				{
					pickedUpButtonGridButtonsRemoveableIndexElementFromPickedUpButtonGridButtonsIndexList = pickupUpButtonGridButtonsIndex;
					break;
				}
			}
			PickedUpButtonGridButtonsIndexList.Remove(pickedUpButtonGridButtonsRemoveableIndexElementFromPickedUpButtonGridButtonsIndexList);
			pickedUpButtonGridButtonsIndex = -1;*/
			#endregion

			PositionFinder(currentPickedUpRandomValue);
			//classForOhterValue = new swappingPositionsConditionsWithValues(false);
	...
	void FindingPlacesForCurrentpickedUpValues(List<int> pickedUpValues, Button pickedUpButton)
	{
		...
		// Holding currentPickedUpRandomValue Initialize
		int currentPickedUpRandomValue = randomIndexValue;

		// Holding pickedUpButtonGridButtonsIndex Initialize
		int pickedUpButtonGridButtonsIndex = -1;
*/
